...
public class StepsTestCase {
    ...
    public void verify_autosuggest(String string) {
        Assert.assertTrue(homePage.getFirstSuggestionText().equalsIgnoreCase(string));
        test.pass("Autosuggest matched: " + string);
    }
